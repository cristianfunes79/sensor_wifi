...
#ifndef DS18B20_H
#define DS18B20_H
#define GPIO_ONEWIRE_BUS    2  //PIN2 ONEWIRE BUS
#define GPIO_STRONG_PULLUP  3 // PIN3 STRONG PULLUP
#define GPIO_OUTPUT_PIN_SEL  (1ULL<<GPIO_ONEWIRE_BUS) // bistmask to indicate wich pins are outputs
#define GPIO_INPUT_PIN_SEL   (1ULL<<GPIO_ONEWIRE_BUS)   //bitmask to indicate which pins are inputs
// Available Functions:
void set_gpio_output();
void set_gpio_input();
void set_strong_pullup();
void OneWireLow(void); //sets the bus low
